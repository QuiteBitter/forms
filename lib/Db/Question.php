 ...
 * @psalm-method 'date'|'datetime'|'dropdown'|'email'|'file'|'long'|'multiple'|'multiple_unique'|'short'|'time' getType()
 * @method void setType(string $value)
 * @psalm-method void setType('date'|'datetime'|'dropdown'|'email'|'file'|'long'|'multiple'|'multiple_unique'|'short'|'time' $value)
